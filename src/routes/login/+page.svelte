<script lang="ts">
	...
	$: validRedirect = redirectTo && redirectTo.startsWith('/') && !redirectTo.startsWith('//') ? redirectTo : '/dashboard';
</script>
...
<div class="page-container">
	<div class="auth-card" in:fly={{ y: 20, duration: 400 }}>
		...
		<div class="google-auth">
			<button class="google-btn dark:bg-slate-800 dark:text-white dark:border-slate-700" on:click={() => signIn('google', { callbackUrl: validRedirect })}>
