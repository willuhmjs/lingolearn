...
export const italianGrammarRules = [
  {
    ...
    description: 'Italian subject pronouns (io, tu, lui/lei, noi, voi, loro). They are often omitted since verb endings convey the subject.',
...
`,
  ...
  },
  {
    ...
    description: 'Regular -ire verbs in the present tense (dormire, sentire) and -isc- group (finire, capire).',
...
`,
    ruleType: 'verb',
    targetForms: ['dormo', 'dormi', 'dorme', 'dormiamo', 'dormite', 'dormono', 'finisco', 'finisci', 'finisce', 'finiamo', 'finite', 'finiscono'],
    level: 'A1',
    dependencies: ['Subject Pronouns']
  },
